...
// import { Highlighter, Film, Clock, Settings, Loader2 } from "lucide-react";
...
//   const [selectedOption, setSelectedOption] = useState("highlights"); // "highlights" or "reels"
//   const [durationOption, setDurationOption] = useState("short");      // "short"|"medium"|"long"
...
//   // map dropdown to seconds
//   const durationMap = { short: 60, medium: 120, long: 180 };
//   const targetSeconds = durationMap[durationOption];
...
//         use_algorithmic: true,              // or expose a checkbox
...
//           <span>Generating {selectedOption}…</span>
//         </div>
//       )}
...
//             <div>
//               <h3 className="flex items-center gap-1 text-lg font-semibold text-gray-800">
//                 <Settings className="w-5 h-5" /> Segments
//               </h3>
...
//                       {new Date(seg.start * 1000)
//                         .toISOString()
//                         .substr(14, 5)}{" "}
//                       –{" "}
//                       {new Date(seg.end * 1000)
//                         .toISOString()
//                         .substr(14, 5)}
//                     </span>
...
//                 Total: {Math.round(result.total_duration)} seconds
//               </p>
//             </div>
//           )}
...
//               setStatus(null);
//             }}
//             className="mt-4 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 px-4 rounded-lg"
//           >
//             Generate New
//           </button>
//         </div>
...
//           You need to <strong>process a video first</strong> before generating
//           highlights.
//         </p>
//       )}
//     </div>
